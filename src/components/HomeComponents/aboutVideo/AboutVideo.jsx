...
const AboutVideo = () => {
  ...
  return (
    <motion.div
      ...
      className="AboutVideo py-5 lg:py-10"
    >
        ...
        <div className="flex flex-wrap justify-between gap-6 lg:gap-[100px]">
          ...
          <div className="contentAbout lg:basis-[40%] flex flex-col gap-7">
            <div className="contentAbout-text">
              ...
              >
                بنية تحتية متكاملة وتحسين جودة الحياة
              </motion.h2>
            </div>
            <motion.p
              initial={{ opacity: 0, lineHeight: "60px" }}
            ...
            >
              يهدف مشروع مدينة الباحة الذكية إلى انشاء بنية تحتية متكاملة تعتمد
              على غرفة قيادة وتحكم مركزية، تتولى إدارة ومراقبة الأنظمة الفرعية
              مثل الإضاءة والري والمراقبة. يتم توفير الاتصال اللاسلكي عبر شبكات
              Wi-Mesh وHi-Mesh من شركة Luceor، فيما تعتمد الإضاءة الذكية على
              أجهزة Schreder مع مستشعرات Meshnode & Datalift، بينما تُدار أنظمة
              الري الذكي بواسطة IRRIOT السويدية. أما المراقبة الذكية فتتم عبر
              كاميرات HIKVISION لتحليل الفيديو وتحسين الأمان. تُجمع البيانات
              لحظيًا وتُحلل في غرفة القيادة والتحكم، ما يضمن إدارة فعالة للأعطال
              واستمرارية التشغيل مع تحقيق التكامل بين جميع الأنظمة
            </motion.p>
          </div>
        </div>
      </div>
