...
const SmartLight = ({ title, heading, image, list, description }) => {
  return (
    <motion.section
    ...
    >
      <div className="container">
        <div className="flex items-center gap-[25px] xl:gap-[100px] flex-col-reverse xl:flex-row py-10 lg:py-0">
          <div className="COntrolImg basis-1/2 w-full  rounded-3xl overflow-hidden relative shadow-video max-h-[350px] flex">
            <img
              src={image}
              alt="controlRoom"
