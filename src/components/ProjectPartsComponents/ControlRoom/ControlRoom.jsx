...
const ControlRoom = ({ title, heading, list, image }) => {
  return (
    <motion.section
    ...
    >
      <div className="container">
        <div className="flex items-center gap-[25px] xl:gap-[100px] flex-col-reverse xl:flex-row">
          <div className="COntrolImg w-full basis-1/2  rounded-3xl overflow-hidden relative shadow-video max-h-[350px]">
            <img
              src={image}
              alt="controlRoom"
          ...
          <div className="controlContent basis-1/2 flex flex-col gap-5 lg:gap-9">
            ...
            >
              {list?.map((item, i) => (
                <li
                  key={i}
                  className="relative flex items-center gap-3 lg:text-lg font-normal leading-7 text-right text-textMain"
                >
